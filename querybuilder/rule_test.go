...
var ruleInputs = []struct {
	...
	{&Rule{ID: "field_nil", Field: "field_nil", Type: "double", Input: "text", Operator: "is_null", Value: 1}, false, errors.Errorf(`expected float but got <nil>`)},
	{&Rule{ID: "date02", Field: "date", Type: "date", Input: "text", Operator: "greater_or_equal", Value: "2019-12-31"}, true, nil},
	{&Rule{ID: "field_nil", Field: "field_nil", Type: "nil", Input: "text", Operator: "is_null", Value: nil}, true, nil},
